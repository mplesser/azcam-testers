...
class Gain(Tester):
    ...
    def acquire(self):
        ...
        azcam.api.config.set_par("imageroot", "ptc.")
    ...
    def report(self):
        ...
        if self.system_noise_correction == []:
            ...
            s = f"Mean system_noise_correction = {mean:5.01f} DN"
            lines.append(s)
            lines.append("")
    ...
    def fe55_gain(self):
        """
        Set gain.system_gain to azcam.api.fe55.system_gain values.
        """

        self.system_gain = azcam.api.fe55.system_gain
